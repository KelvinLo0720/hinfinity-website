        ...
        <div className="apply-panel motion-card">
          <div className="apply-facts">
            <div className="apply-fact">
              ...
              <span>
                {applicationConfig.applicationOpen} –{" "}
                {applicationConfig.applicationClose}
              </span>
            </div>
          ...
          <Localized
            ...
            zh={
              <>
                <strong>申請前提醒：</strong>
                每位申請者都需要填寫基本資料及準備一份 PDF CV；團隊申請只需共同回答一份 Q1–Q6。
              </>
            }
            en={
              <>
                <strong>Before you apply:</strong>
                each applicant needs to provide basic details and prepare one PDF CV; team applicants submit one shared set of Q1–Q6 answers.
              </>
            }
          />
          ...
          <Link className="text-link" href="/privacy">
            <Localized
              zh="閱讀私隱及資料使用說明 →"
              en="Read the privacy and data-use notes →"
            />
          </Link>
        </div>
      </section>
