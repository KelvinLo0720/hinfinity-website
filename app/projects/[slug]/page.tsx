...
export default async function ProjectDetailPage({
  ...
  const sections = [
    ...
    ["02 / THE IDEA", "項目方向", "The idea", project.summary, project.summaryEn],
    ["03 / THE SHIFT", "關鍵轉折", "The shift", project.shift, project.shiftEn],
  ...
  return (
    <>
      ...
      <section className="section-tight">
        <div className="shell">
          {sections.map(([label, zhTitle, enTitle, zhCopy, enCopy]) => (
            <article className="case-study motion-card" key={label}>
              <b>{label}</b>
              <div>
                <Localized as="h2" zh={zhTitle} en={enTitle} />
